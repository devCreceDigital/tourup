...
type TipoActividadUi = { icon: typeof Bus; color: string; bg: string; barColor: string };
...
const TIPO_DEFAULT: TipoActividadUi = { icon: Coffee, color: "text-[#185FA5]", bg: "bg-[#e6f1fb]", barColor: "#185FA5" };
const TIPO: Record<string, TipoActividadUi> = {
            ...
            <>
              ...
              <div className="space-y-3">
                {dia.actividades.map(act => {
                  ...
                  const tipoInfo = TIPO[act.tipo] ?? TIPO_DEFAULT;
