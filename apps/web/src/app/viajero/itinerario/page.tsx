...
import { resolveDestinations } from "@/shared/data/geoHelper";
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        const viajeRes = await requestTotemApi(`/trips/${viajeId}/`);
        ...
        const iRes = await requestTotemApi(`/itineraries/${viaje.itinerario_id}/`);
