...
import ItineraryCard from "@/contexts/assistant/ui/components/tool-cards/ItineraryCard"
import BudgetCard from "@/contexts/assistant/ui/components/tool-cards/BudgetCard"
import WeatherCard from "@/contexts/assistant/ui/components/tool-cards/WeatherCard"
...
function PdfDownloadButton({ token }: { token: string }) {
  ...
  const handleDownload = async () => {
    setLoading(true)
    try {
      const res = await fetch(assistantUrl(`/trips/${token}/pdf/`))
