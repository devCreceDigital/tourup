  ...
  return (
    <div className="bg-white rounded-[8px] border border-[#E0E4EF] overflow-hidden shadow-[0_2px_16px_rgba(0,0,0,0.10)]">
      ...
      <div className="p-8 bg-[#EEF0F8] min-h-[400px] flex items-center justify-center">
        <div className="bg-white rounded-[8px] border border-[#E0E4EF] p-8 max-w-md text-center">
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#EEF0F8] mb-4">
            <ClipboardList className="h-7 w-7 text-[#5B5BDB]" />
          </div>
