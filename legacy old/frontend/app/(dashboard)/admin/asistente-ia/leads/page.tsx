...
import LeadsTable from "@/components/asistente-ia/LeadsTable"
import LeadDetailModal from "@/components/asistente-ia/LeadDetailModal"
...
export default function AsistenteIALeadsPage() {
  ...
  const loadLeads = useCallback(async () => {
    try {
      ...
      const res = await fetchDjango(`/asistente-ia/agency/leads/${qs}`)
      if (res.ok) {
