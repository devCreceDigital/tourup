            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap gap-3 mt-3 text-sm text-muted-foreground">
                ...
                <span className="flex items-center gap-1">
                  ...
                  {operator.clase ?? operator.operator_type}
                </span>
                {operator.modalidad_autorizada && (
              ...
              {(operator.rep_legal || operator.nro_certificado || operator.fecha_expedicion) && (
                <div className="flex flex-wrap gap-4 mt-2 text-xs text-muted-foreground border-t border-border/50 pt-2">
                  {operator.rep_legal && (
                    <span><span className="font-medium text-foreground/70">Rep. Legal:</span> {operator.rep_legal}</span>
                  )}
                  {operator.nro_certificado && (
                    <span><span className="font-medium text-foreground/70">Cert. MINCETUR:</span> {operator.nro_certificado}</span>
                  )}
                  {operator.fecha_expedicion && (
                    <span><span className="font-medium text-foreground/70">Expedición:</span> {operator.fecha_expedicion}</span>
                  )}
                </div>
              )}
